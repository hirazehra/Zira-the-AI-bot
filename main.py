...
class voiceAssistantGrid(GridLayout):
    def __init__(self, **kwargs):
        super(voiceAssistantGrid, self).__init__()

        self.rows = 2
        self.add_widget(Image(source="ai.gif"))



        #self.add_widget(Label(text="Hello, \nI am Zira, \nYour Voice Assistant. "))

        self.press = Button(text="Listen",size_hint =(.2, .2), pos_hint ={'center_x':.7, 'center_y':.5})
    ...
    def click(self, instance):
        ...
        if __name__ == "__main__":
            ...
            while True:
                ...
                elif 'email to my best friend' in query:
                    try:
